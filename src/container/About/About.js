                        ...
                        <div className="col-md-6">
                            <div className="custom-progress m-t-40">
                                <div className="skill-progressbar" data-aos="fade-up" data-aos-delay={0}>
                                    ...
                                    <div className="line-progressbar" data-percentage={75} data-progress-color="#b19361" />
                                </div>
                        ...
                        <div className="row mb-n6">
                            <div className="col-xl-3 mb-5">
                                <div className="team-single" data-aos="fade-up" data-aos-delay={0}>
                                    <div className="team-img">
                                        <img className="img-fluid" src="assets/images/team/leader1.png" alt />
                                    </div>
                            ...
                            <div className="col-xl-3 mb-5">
                                <div className="team-single" data-aos="fade-up" data-aos-delay={200}>
                                    <div className="team-img">
                                        <img className="img-fluid" src="assets/images/team/leader2.png" alt />
                                    </div>
                                    <div className="team-content">
                            ...
                            <div className="col-xl-3 mb-5">
                                <div className="team-single" data-aos="fade-up" data-aos-delay={400}>
                                    <div className="team-img">
                                        <img className="img-fluid" src="assets/images/team/leader3.png" alt />
                                    </div>
                                    <div className="team-content">
                                        <h6 className="team-name font--bold mt-5">Missa Santos</h6>
                            ...
                            <div className="col-xl-3 mb-5">
                                <div className="team-single" data-aos="fade-up" data-aos-delay={600}>
                                    <div className="team-img">
                                        <img className="img-fluid" src="assets/images/team/leader4.png" alt />
                                    </div>
                                    <div className="team-content">
                        ...
                        <div className="row">
                            <div className="col-12">
                                <div className="company-logo-slider default-slider-nav-arrow">
                                    ...
                                    <div className="swiper-container company-logo-slider">
                                        ...
                                        <div className="swiper-wrapper">
                                            ...
                                            <div className="company-logo-single-item swiper-slide">
                                                <div className="image"><img className="img-fluid" src="assets/images/company-logo/company-logo-1.png" alt /></div>
                                            </div>
                                            {/* End Company Logo Single Item */}
                                            {/* Start Company Logo Single Item */}
                                            <div className="company-logo-single-item swiper-slide">
                                                <div className="image"><img className="img-fluid" src="assets/images/company-logo/company-logo-2.png" alt /></div>
                                            </div>
                                            {/* End Company Logo Single Item */}
                                            {/* Start Company Logo Single Item */}
                                            <div className="company-logo-single-item swiper-slide">
                                                <div className="image"><img className="img-fluid" src="assets/images/company-logo/company-logo-3.png" alt /></div>
                                            </div>
                                            {/* End Company Logo Single Item */}
                                            {/* Start Company Logo Single Item */}
                                            <div className="company-logo-single-item swiper-slide">
                                                <div className="image"><img className="img-fluid" src="assets/images/company-logo/company-logo-4.png" alt /></div>
                                            </div>
                                            {/* End Company Logo Single Item */}
                                            {/* Start Company Logo Single Item */}
                                            <div className="company-logo-single-item swiper-slide">
                                                <div className="image"><img className="img-fluid" src="assets/images/company-logo/company-logo-5.png" alt /></div>
                                            </div>
                                            {/* End Company Logo Single Item */}
                                            {/* Start Company Logo Single Item */}
                                            <div className="company-logo-single-item swiper-slide">
                                                <div className="image"><img className="img-fluid" src="assets/images/company-logo/company-logo-6.png" alt /></div>
                                            </div>
                                            {/* End Company Logo Single Item */}
                                            {/* Start Company Logo Single Item */}
                                            <div className="company-logo-single-item swiper-slide">
                                                <div className="image"><img className="img-fluid" src="assets/images/company-logo/company-logo-7.png" alt /></div>
                                            </div>
                                            {/* End Company Logo Single Item */}
                                            {/* Start Company Logo Single Item */}
                                            <div className="company-logo-single-item swiper-slide">
                                                <div className="image"><img className="img-fluid" src="assets/images/company-logo/company-logo-8.png" alt /></div>
                                            </div>
                                            {/* End Company Logo Single Item */}
                                        </div>
                                    </div>
                                    ...
                                    <div className="swiper-button-next d-none d-md-block" />
                                </div>
                            </div>
                        </div>
                    </div>
