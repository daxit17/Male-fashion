                                ...
                                <div className="breadcrumb-nav breadcrumb-nav-color--black breadcrumb-nav-hover-color--golden">
                                    <nav aria-label="breadcrumb">
                                        <ul>
                                            ...
                                            <li className="active" aria-current="page">Privacy Policy</li>
                                        </ul>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="privacy-policy-wrapper">
                                ...
                                <div className="privacy-single-item" data-aos="fade-up" data-aos-delay={0}>
                                ...
                                {/* Start Privacy Policy Single Item */}
                                <div className="privacy-single-item" data-aos="fade-up" data-aos-delay={0}>
                                    <h3 className="title">What personal data we collect and why we collect it</h3>
                                ...
                                {/* Start Privacy Policy Single Item */}
                                <div className="privacy-single-item" data-aos="fade-up" data-aos-delay={0}>
                                    <h4 className="sub-title">Media</h4>
                                ...
                                {/* Start Privacy Policy Single Item */}
                                <div className="privacy-single-item" data-aos="fade-up" data-aos-delay={0}>
                                    <h4 className="sub-title">Cookies</h4>
                                ...
                                {/* Start Privacy Policy Single Item */}
                                <div className="privacy-single-item" data-aos="fade-up" data-aos-delay={0}>
                                    <h4 className="sub-title">Embedded content from other websites</h4>
                                ...
                                {/* Start Privacy Policy Single Item */}
                                <div className="privacy-single-item" data-aos="fade-up" data-aos-delay={0}>
                                    <h4 className="sub-title">How long we retain your data</h4>
                                ...
                                {/* Start Privacy Policy Single Item */}
                                <div className="privacy-single-item" data-aos="fade-up" data-aos-delay={0}>
                                    <h4 className="sub-title">What rights you have over your data</h4>
                                ...
                                {/* Start Privacy Policy Single Item */}
                                <div className="privacy-single-item" data-aos="fade-up" data-aos-delay={0}>
                                    <h4 className="sub-title">Where we send your data</h4>
